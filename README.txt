...
Pre-processing:
1.'modify.py' is used for transferring one line json data ('abstract10000.json') to multiple-lines ('modified_abstract.json').
...
4.'HumanAnnotatedAnalysis.ipynb' is used for analysing the Human Annotated result ('regulationAnnotatedAll.txt', 'negationSamplesAll.txt').
